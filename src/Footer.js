    ...
    return (
        <Fragment>    
            ...
            <p className="col s12">Domingos Netto</p>
                ...
                <a href="https://www.linkedin.com/in/domingos-netto/" className="material-icons"><i className='bx bxl-linkedin' ></i></a>
                <a href="https://www.instagram.com/artsystemti/" className="material-icons"><i className='bx bxl-instagram' ></i></a>
                <a href="https://twitter.com/artsystemti" className="material-icons"><i className='bx bxl-twitter' ></i></a>
